...
proc create_root_design { parentCell } {
  ...
  # Create instance: IR_Channel1, and set properties
  set IR_Channel1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 IR_Channel1 ]
...
CONFIG.c_sg_include_stscntrl_strm {0} \
  ...
  # Create instance: IR_Channel2, and set properties
  set IR_Channel2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 IR_Channel2 ]
  set_property -dict [ list \
CONFIG.c_include_s2mm {0} \
CONFIG.c_include_sg {0} \
CONFIG.c_sg_include_stscntrl_strm {0} \
  ...
  # Create instance: IR_Channel3, and set properties
  set IR_Channel3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 IR_Channel3 ]
  set_property -dict [ list \
CONFIG.c_include_s2mm {0} \
CONFIG.c_include_sg {0} \
CONFIG.c_sg_include_stscntrl_strm {0} \
  ...
  # Create instance: OP_Channel1, and set properties
  set OP_Channel1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 OP_Channel1 ]
  set_property -dict [ list \
...
CONFIG.c_sg_include_stscntrl_strm {0} \
  ...
  # Create instance: OP_Channel2, and set properties
  set OP_Channel2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 OP_Channel2 ]
  set_property -dict [ list \
CONFIG.c_include_mm2s {0} \
CONFIG.c_include_s2mm {1} \
CONFIG.c_include_sg {0} \
...
CONFIG.NUM_SI {5} \
  ...
  # Create instance: edge_filter_0, and set properties
  set edge_filter_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:edge_filter:1.0 edge_filter_0 ]
...
CONFIG.NUM_MI {6} \
  ...
  connect_bd_intf_net -intf_net IR_Channel1_M_AXIS_MM2S [get_bd_intf_pins IR_Channel1/M_AXIS_MM2S] [get_bd_intf_pins edge_filter_0/A]
  connect_bd_intf_net -intf_net IR_Channel2_M_AXIS_MM2S [get_bd_intf_pins IR_Channel2/M_AXIS_MM2S] [get_bd_intf_pins edge_filter_0/B]
  connect_bd_intf_net -intf_net IR_Channel3_M_AXIS_MM2S [get_bd_intf_pins IR_Channel3/M_AXIS_MM2S] [get_bd_intf_pins edge_filter_0/E]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins IR_Channel1/M_AXI_MM2S] [get_bd_intf_pins axi_mem_intercon/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_MM2S [get_bd_intf_pins IR_Channel2/M_AXI_MM2S] [get_bd_intf_pins axi_mem_intercon/S01_AXI]
  connect_bd_intf_net -intf_net axi_dma_2_M_AXI_MM2S [get_bd_intf_pins IR_Channel3/M_AXI_MM2S] [get_bd_intf_pins axi_mem_intercon/S02_AXI]
  connect_bd_intf_net -intf_net axi_dma_3_M_AXI_S2MM [get_bd_intf_pins OP_Channel2/M_AXI_S2MM] [get_bd_intf_pins axi_mem_intercon/S03_AXI]
  connect_bd_intf_net -intf_net axi_dma_4_M_AXI_S2MM [get_bd_intf_pins OP_Channel1/M_AXI_S2MM] [get_bd_intf_pins axi_mem_intercon/S04_AXI]
  connect_bd_intf_net -intf_net axi_mem_intercon_M00_AXI [get_bd_intf_pins axi_mem_intercon/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  connect_bd_intf_net -intf_net edge_filter_0_C [get_bd_intf_pins OP_Channel2/S_AXIS_S2MM] [get_bd_intf_pins edge_filter_0/C]
  connect_bd_intf_net -intf_net edge_filter_0_D [get_bd_intf_pins OP_Channel1/S_AXIS_S2MM] [get_bd_intf_pins edge_filter_0/D]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins OP_Channel1/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins IR_Channel1/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins IR_Channel2/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins IR_Channel3/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins OP_Channel2/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins edge_filter_0/s_axi_ctrl] [get_bd_intf_pins ps7_0_axi_periph/M05_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins IR_Channel1/m_axi_mm2s_aclk] [get_bd_pins IR_Channel1/s_axi_lite_aclk] [get_bd_pins IR_Channel2/m_axi_mm2s_aclk] [get_bd_pins IR_Channel2/s_axi_lite_aclk] [get_bd_pins IR_Channel3/m_axi_mm2s_aclk] [get_bd_pins IR_Channel3/s_axi_lite_aclk] [get_bd_pins OP_Channel1/m_axi_s2mm_aclk] [get_bd_pins OP_Channel1/s_axi_lite_aclk] [get_bd_pins OP_Channel2/m_axi_s2mm_aclk] [get_bd_pins OP_Channel2/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axi_mem_intercon/S03_ACLK] [get_bd_pins axi_mem_intercon/S04_ACLK] [get_bd_pins edge_filter_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins IR_Channel1/axi_resetn] [get_bd_pins IR_Channel2/axi_resetn] [get_bd_pins IR_Channel3/axi_resetn] [get_bd_pins OP_Channel1/axi_resetn] [get_bd_pins OP_Channel2/axi_resetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins axi_mem_intercon/S03_ARESETN] [get_bd_pins axi_mem_intercon/S04_ARESETN] [get_bd_pins edge_filter_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces IR_Channel1/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces IR_Channel2/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces IR_Channel3/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces OP_Channel1/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces OP_Channel2/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x00010000 -offset 0x40400000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs IR_Channel1/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40410000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs IR_Channel2/S_AXI_LITE/Reg] SEG_axi_dma_1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40420000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs IR_Channel3/S_AXI_LITE/Reg] SEG_axi_dma_2_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40430000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs OP_Channel2/S_AXI_LITE/Reg] SEG_axi_dma_3_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40440000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs OP_Channel1/S_AXI_LITE/Reg] SEG_axi_dma_4_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs edge_filter_0/s_axi_ctrl/Reg] SEG_edge_filter_0_Reg
...
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -y 240 -defaultsOSRD
preplace inst IR_Channel1 -pg 1 -lvl 3 -y 170 -defaultsOSRD
preplace inst IR_Channel2 -pg 1 -lvl 3 -y 340 -defaultsOSRD
preplace inst IR_Channel3 -pg 1 -lvl 3 -y 500 -defaultsOSRD
preplace inst edge_filter_0 -pg 1 -lvl 4 -y 300 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 390 -defaultsOSRD
preplace inst OP_Channel1 -pg 1 -lvl 5 -y 260 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 6 -y 560 -defaultsOSRD
preplace inst OP_Channel2 -pg 1 -lvl 5 -y 460 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 7 -y 260 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 7 1 NJ
preplace netloc axi_dma_4_M_AXI_S2MM 1 5 1 1700
preplace netloc ps7_0_axi_periph_M02_AXI 1 2 1 690
preplace netloc IR_Channel1_M_AXIS_MM2S 1 3 1 1050
preplace netloc axi_dma_1_M_AXI_MM2S 1 3 3 1030J 170 N 170 1730
preplace netloc processing_system7_0_M_AXI_GP0 1 1 7 380 50 NJ 50 NJ 50 NJ 50 NJ 50 NJ 50 2420
preplace netloc IR_Channel3_M_AXIS_MM2S 1 3 1 1070
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 8 20 70 NJ 70 NJ 70 NJ 70 NJ 70 NJ 70 NJ 70 2430
preplace netloc IR_Channel2_M_AXIS_MM2S 1 3 1 1040
preplace netloc axi_dma_3_M_AXI_S2MM 1 5 1 N
preplace netloc ps7_0_axi_periph_M03_AXI 1 2 1 640
preplace netloc axi_mem_intercon_M00_AXI 1 6 1 2010
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 640
preplace netloc rst_ps7_0_50M_interconnect_aresetn 1 1 5 370 80 NJ 80 NJ 80 N 80 1710
preplace netloc axi_dma_0_M_AXI_MM2S 1 3 3 NJ 140 N 140 1740
preplace netloc edge_filter_0_C 1 4 1 1340
preplace netloc processing_system7_0_FIXED_IO 1 7 1 NJ
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 5 350 620 670 620 1080 620 1360 620 1740
preplace netloc edge_filter_0_D 1 4 1 1340
preplace netloc ps7_0_axi_periph_M05_AXI 1 2 2 680 250 NJ
preplace netloc axi_dma_2_M_AXI_MM2S 1 3 3 N 470 1370J 370 1690J
preplace netloc ps7_0_axi_periph_M04_AXI 1 2 3 N 420 NJ 420 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 8 30 90 360 90 660 90 1060 90 1350 90 1720 90 2000 90 2410
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 3 650 260 1040J 200 1370J
levelinfo -pg 1 0 190 510 870 1210 1530 1870 2210 2450 -top -100 -bot 790
",
}
